...
class UserAccountForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'account_type', 'birth_date','gender_type', 'postal_code', 'city','country', 'street_address']
    ...
    def save(self, commit=True):
        ...
        if commit == True:
            ...
            gender = self.cleaned_data.get('gender_type')
...
class UserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            ...
            if user_account:
                # self.fields['first_name'].initial=self.first_name
